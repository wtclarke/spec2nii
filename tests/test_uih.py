...
data_base = Path('tests/spec2nii_test_data/UIH')
...
def test_uih_svs(tmp_path):
    ...
    combined.save(Path(__file__).parent / 'uih_svs.png')
...
def test_uih_2d_csi(tmp_path):
    ...
    combined.save(Path(__file__).parent / 'uih_csi_2d.png')
...
def test_uih_3d_csi(tmp_path):
    ...
    combined.save(Path(__file__).parent / 'uih_csi_3d.png')
